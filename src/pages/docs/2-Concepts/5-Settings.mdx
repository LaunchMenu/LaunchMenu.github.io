...
```tsx title=src/index.tsx source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/settings
...
The settings context is used to store instances of the setting trees that can be created from the settings declaration. The [`IOContext`]() <!-- TODO: add link --> will contain such a settings context. The settings context within the `IOContext` obtained from a [`session`]() <!-- TODO: add link --> will contain instances of the settings trees that have been loaded with the settings as saved on disk.
...
```ts title=SettingsContext.ts source=https://github.com/LaunchMenu/LaunchMenu/blob/feature/globalKeyListener/packages/core/src/settings/SettingsContext.ts
...
```tsx title=src/index.tsx source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/settingsOverride
...
The `SettingsFile` class builds on top of several layers of file management classes. These classes can be used for other file management too, and can be viewed on [github](https://github.com/LaunchMenu/LaunchMenu/tree/feature/globalKeyListener/packages/core/src/settings/storage/fileTypes).

```ts title=SettingsFile.ts source=https://github.com/LaunchMenu/LaunchMenu/blob/feature/globalKeyListener/packages/core/src/settings/storage/fileTypes/SettingsFile.ts
...
```tsx title=src/index.tsx source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/settingsCustom
...
```ts title=settingsItemProperties.ts
icon: "settings",
searchPattern: settingPatternMatcher,
resetable: true,
```
