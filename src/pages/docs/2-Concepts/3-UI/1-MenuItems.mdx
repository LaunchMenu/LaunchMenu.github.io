...
The `view` specifies the React component to render, and the `actionBindings` specify data that can be used to interact with the item. You can learn more about these action bindings on the in-depth [actions page](). <!-- TODO: add reference -->

Or check a list with the [most commonly used actions](). <!-- TODO: add reference -->
...
```tsx title=src/index.tsx source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/menuItemsStandard
const items = [
...
```tsx title=src/index.tsx source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/menuItemsCustom
...
```ts title=src/index.tsx source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/menuItemsFolder
// Object children
...
These field menu items allow us to easily create a menu of properties that the user can update. LaunchMenu comes with several build in types of field items, but also has a [`createFieldMenuItem` factory function](https://github.com/LaunchMenu/LaunchMenu/blob/master/packages/core/src/menus/items/inputs/createFieldMenuItem.tsx) to create your own.

```tsx title=src/index.tsx source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/menuItemsCustomField
