...
```tsx title=ITextField source=https://github.com/LaunchMenu/LaunchMenu/blob/master/packages/core/src/textFields/_types/ITextField.ts
...
For simple usage of a text field, all you have to do is create the data structure and pass it using a [UILayer]() class instance, which will take care of creating the `createStandardTextFieldKeyHandler` and `TextFieldView`:

<!-- TODO: add reference -->

```tsx title=src/index.tsx source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/textField
...
```tsx title=src/index.tsx source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/textFieldCustomView
export default declare({
    info,
    settings,
    open({context, onClose}) {
...
```tsx title=src/index.tsx source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/textFieldCustomController
export default declare({
    info,
    settings,
    open({context, onClose}) {
...
```tsx title=src/index.tsx source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/textFieldMultiline
export default declare({
    info,
    settings,
    open({context, onClose}) {
...
```tsx title=src/index.tsx source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/textFieldHighlightLexer
...
```tsx title=src/index.tsx source=source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/textFieldHighlightGrammar spoiler
