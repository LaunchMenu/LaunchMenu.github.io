...
Commands are simply objects that allow for executing and reverting of actions. The `UndoRedoFacility` takes care of tracking these commands, and executing or reverting them in the right order. A shared instance of this facility can be found in the [`IOContext`](). <!-- TODO: add reference -->

The execute action also has built-in support for command execution, which you can learn more about on the [actions page](). <!-- TODO: add reference -->

Below is an example of using one of the simplest built-in commands, the `SetFieldCommand`:

```tsx title=src/index.ts source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/undoRedo
...
```tsx title=src/index.ts source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/undoRedoCommands
...
```tsx title=src/index.ts source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/undoRedoCompoundCommand
...
```tsx title=src/index.ts source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/undoRedoResources
