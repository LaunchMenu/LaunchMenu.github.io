...
```ts title=src/index.ts source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/appletFormat
...
```ts title=src/index.ts source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/appletFormatGlobalContextBinding
...
```ts title=src/index.ts source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/appletFormatGlobalContextBindingDirect
export default declare({
    info,
    settings,
    globalContextMenuBindings: [
...
To learn more about actions and the context menu, check the in-depth [actions page]().
...
The below example will initialize a file watcher, and dispose it on reload. The `LaunchMenu` instance isn't used.o

```ts title=src/index.ts source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/appletFormatInit
export default declare({
    info,
    settings,
    init: ({LM}) => {
...
```ts title=src/index.ts source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/appletFormatWithSession
export default declare({
    info,
    settings,
    withSession: session => {
