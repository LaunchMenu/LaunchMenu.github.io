...
There are several situations in whichthe context becomes of use:

-   Wanting to dispatch [undoable commands]() <!-- TODO: add reference -->
-   Wanting to open new UI [using UI layers]() <!-- TODO: add reference -->
...
-   From [an execute handler]() <!-- TODO: add reference -->
...
Overriding some part of the context is rather easy, by using the `IOContext` class and specifying what the parent context is:
...
```tsx title=src/index.tsx source=https://github.com/LaunchMenu/LM-applet-examples/tree/main/examples/baseContext
