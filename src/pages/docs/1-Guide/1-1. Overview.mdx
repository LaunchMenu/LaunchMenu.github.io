...
We highly recommend reading through and or following along with this guide, but you can find the final [on github](https://github.com/LaunchMenu/LM-applet-quickstart) if you just want a quick example nonetheless.
