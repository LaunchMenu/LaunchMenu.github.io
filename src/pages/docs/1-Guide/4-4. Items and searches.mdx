...
The `createStandardMenuItem` factory accepts many more configuration fields. Some of these we will see in the remainder of the guide, but to learn about all of them you can check the in-depth [menu items page]().

<!-- TODO: add reference to menu items page -->
...
<!-- TODO: add reference to search system page -->
