...
{
    "scripts": {
        "installLocal": "electron scripts/installLocal.js",
        "uninstallLocal": "electron scripts/uninstallLocal.js"
    }
}
```
...
This will ask you to select the directory that LaunchMenu is installed the first time that you run this (and it's saved in `script/installPath.json` for later use), and install your applet locally. The `uninstallLocal` script can later be used to uninstall it again.
