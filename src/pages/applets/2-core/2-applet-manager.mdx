...
<ScreenShot src="/applets/applet-manager/banner.png" alt="Notes banner" />

## Features

Currently the applet manager only allows you to open applets.
Simply search for the applet you're interested in, and execute the primary action on an applet to open it.
