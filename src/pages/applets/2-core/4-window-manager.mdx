...
-   <Key>ctrl</Key>+<Key>shift</Key>+<Key>q</Key>: Closes LaunchMenu |ithout
...
The closing controls described in the [closing](#window-closing) section are present within the global context menu, together with restart and shutdown controls to either restart Launchmenu or quite LaunchMenu completly.
...
<ScreenShot src="/applets/dictionary/banner.png" alt="LaunchMenu position" />
...
<ScreenShot src="/applets/dictionary/banner.png" alt="LaunchMenu size" />
...
<ScreenShot src="/applets/dictionary/banner.png" alt="Visiblity controls" />
