...
The dictionary has limited multi-language support.

<ScreenShot src="/applets/dictionary/banner.png" alt="Dictionary banner" />
...
<ScreenShot src="/applets/dictionary/banner.png" alt="Search words" />
...
Finally, you can also search for only definiotns by opening Dictionary using the [applet-manager](/applets/core/applet-manager).
